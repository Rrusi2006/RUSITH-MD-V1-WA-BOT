...
async function connectToWA() {
  ...
  console.log("Connecting ❤️𝙍𝙐𝙎𝙄𝙏𝙃_𝙈𝘿_𝙑1❤️");
  ...
  robin.ev.on("connection.update", (update) => {
    ...
    if (connection === "close") {
      ...
      console.log("❤️𝙍𝙐𝙎𝙄𝙏𝙃_𝙈𝘿_𝙑1❤️ installed successful ✅");
      console.log("❤️𝙍𝙐𝙎𝙄𝙏𝙃_𝙈𝘿_𝙑1❤️ connected to whatsapp ✅");

      let up = `❤️𝙍𝙐𝙎𝙄𝙏𝙃_𝙈𝘿_𝙑1❤️ connected successful ✅`;
      let up1 = `Hello Rusith_md_bot, I made bot successful`;
      ...
      robin.sendMessage("94772136479@s.whatsapp.net", {
        image: {
          url: `https://raw.githubusercontent.com/Rrusi2006/Bot-images/refs/heads/main/20250427_201853.jpg`,
        },
        caption: up1,
...
app.get("/", (req, res) => {
  res.send("hey, ❤️𝙍𝙐𝙎𝙄𝙏𝙃_𝙈𝘿_𝙑1❤️ started✅");
});
app.listen(port, () =>
